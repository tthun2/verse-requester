  ...
  [
    {
      args: ["node", "", "Ge", "1:1"],
      expected:
        "Ge 1:1 cannot be found. Please check the reference and try again.",
    },
    {
      args: ["node", "", "Genesis", "12111:2"],
      expected:
        "Genesis 12111:2 cannot be found. Please check the reference and try again.",
    },
    {
      args: ["node", "", "Matt", "1:1444"],
      expected:
        "Matt 1:1444 cannot be found. Please check the reference and try again.",
    },
    {
      args: ["node", "", "Rev", "23:1"],
      expected:
        "Rev 23:1 cannot be found. Please check the reference and try again.",
    },
    {
      args: ["node", "", "Matt", "1:1", "a"],
      expected:
        "Matt 1:1,a cannot be found. Please check the reference and try again.",
    },
  ].forEach(({ args, expected }) => {
    expect(verseRequester(args)).equal(expected);
  });
